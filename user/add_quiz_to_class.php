                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										<li><a href="#">College Year: <?php echo $school_year_query_row['school_year']; ?></a><span class="divider">/</span></li>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Test Time</label>
											<div class="controls">
